...
* 두 번째 프로젝트 Mini Game Hub 추가
* Projects 페이지에 MGH 프로젝트 카드 추가
* `projects/mgh.html` 프로젝트 상세 페이지 추가
* MGH 프로젝트 정보, 제작 목적, 사용 기술, 주요 기능, 개발 과정 정리
* MGH의 싱글플레이 / 멀티플레이 게임 구조 설명 추가

### Improved

* Projects 페이지 소개 문구 수정
* 등록된 프로젝트 수 1개에서 2개로 변경
* Coming Soon 카드 일부를 실제 프로젝트 카드로 교체

### Notes

* v1.1.0은 포트폴리오 사이트에 두 번째 실제 프로젝트를 추가하는 업데이트입니다.
* 다음 버전에서는 프로젝트 상세 페이지 디자인 개선과 모바일 반응형 개선을 진행할 예정입니다.
